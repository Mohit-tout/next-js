export default function NavbarComponent() {
    return (
        <>
            <header className="sticky top-0 bg-white text-gray-700 body-font border-b border-gray-200">
            ...
            <section className="text-gray-700 body-font overflow-hidden border-t border-gray-200">
                <div className="container px-5 py-24 mx-auto flex flex-wrap">
                    ...
                    <div className="flex lg:w-3/4 w-full flex-wrap lg:border border-gray-300 rounded-lg">
                        ...
                        <div className="lg:w-1/3 lg:-mt-px w-full mb-10 lg:mb-0 border-2 rounded-lg border-indigo-500">
                            <div className="px-2 text-center h-48 flex flex-col items-center justify-center">
